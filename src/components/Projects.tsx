...
const Projects = () => {
	const projects = [
		{
			...
			description: ".",
			techStack: ["React", "TypeScript", "Vite", "PostgreSQL"],
			githubUrl: "https://github.com/gmdeveloper",
			liveUrl: "https://campusconnect-pearl-three.vercel.app/",
			image: "https://ibb.co/wZ7DP286",
		},
		{
			title: "NexaFlow",
			description:
				"A task management system with kanban boards, customizable workflows and automated status updates for efficient project management.",
		...
		},
		{
			title: "DataViz",
			description:
				"An interactive data visualization tool for complex datasets, supporting various chart types and real-time data updates.",
	...
	return (
		<section
			id="projects"
			className="min-h-screen py-20 animated-bg cyber-grid"
		>
							...
							<div className="relative group">
								...
								<div className="absolute inset-0 bg-black/60 opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-center justify-center">
									<div className="text-center p-4">
										<div className="mb-2 text-xs terminal-text">
											// project.view();
										</div>
										<a
